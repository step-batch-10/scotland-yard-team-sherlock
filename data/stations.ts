export const stations: {
  ...
  13: {
    ...
    black: [4, 23, 24, 14, 23, 52, 46, 67, 89],
  },
  14: {
    taxi: [25, 15],
    bus: [13, 15],
  ...
  22: {
    ...
    bus: [3, 23, 34, 65],
    underground: [],
    black: [11, 23, 34, 35, 3, 23, 34, 65],
  },
  23: {
    taxi: [12, 13, 22, 37],
    bus: [3, 22, 13, 67],
    underground: [],
    black: [12, 13, 22, 37, 3, 22, 13, 67],
  },
  24: {
    taxi: [13, 37, 38],
    bus: [],
  ...
  29: {
    ...
    bus: [15, 41, 42, 55],
    underground: [],
    black: [6, 16, 17, 41, 42, 15, 41, 42, 55],
  },
  30: {
    taxi: [17, 42],
    bus: [],
  ...
  41: {
    ...
    bus: [15, 29, 52, 87],
    underground: [],
    black: [40, 54, 29, 28, 15, 29, 52, 87],
  },
  42: {
    taxi: [29, 30, 56, 72],
    bus: [7, 29, 72],
    underground: [],
    black: [29, 30, 56, 72, 7, 29, 72],
  },
  43: {
    taxi: [18, 31, 57],
    bus: [],
  ...
  46: {
    ...
    black: [33, 45, 47, 61, 1, 34, 58, 78, 1, 13, 74, 79],
  },
  47: {
    taxi: [46, 34, 62],
    bus: [],
  ...
  58: {
    ...
    bus: [1, 46, 74, 77],
    underground: [],
    black: [44, 45, 57, 59, 75, 74, 1, 46, 74, 77],
  },
  59: {
    taxi: [45, 58, 75, 76],
    bus: [],
  ...
  63: {
    ...
    bus: [34, 65, 79, 100],
    underground: [],
    black: [48, 64, 79, 80, 34, 65, 79, 100],
  },
  64: {
    taxi: [63, 65, 81],
    bus: [],
  ...
  67: {
    ...
    black: [51, 66, 68, 84, 23, 52, 65, 82, 102, 13, 79, 89, 111],
  },
  68: {
    taxi: [51, 67, 69, 85],
    bus: [],
  ...
  78: {
    ...
    bus: [46, 58, 79],
    underground: [],
    black: [61, 77, 79, 97, 46, 58, 79],
  },
  79: {
    taxi: [62, 63, 78, 98],
    bus: [63, 78],
    underground: [46, 67, 93, 111],
    black: [62, 63, 78, 98, 63, 78, 46, 67, 93, 111],
  },
  80: {
    taxi: [63, 99, 100],
    bus: [],
  ...
  82: {
    ...
    bus: [65, 67, 100, 140],
    underground: [],
    black: [65, 66, 81, 101, 65, 67, 100, 140],
  },
  83: {
    taxi: [101, 102],
    bus: [],
  ...
  86: {
    ...
    bus: [52, 87, 102, 116],
    underground: [],
    black: [69, 103, 104, 52, 87, 102, 116],
  },
  87: {
    taxi: [70, 88],
    bus: [41, 86, 105],
  ...
  89: {
    ...
    black: [71, 88, 105, 55, 105, 13, 67, 140, 159],
  },
  90: {
    taxi: [72, 91, 105],
    bus: [],
  ...
  100: {
    ...
    bus: [63, 111, 82],
    underground: [],
    black: [80, 81, 101, 112, 113, 63, 111, 82],
  },
  101: {
    taxi: [100, 82, 114, 83],
    bus: [],
  ...
  105: {
    ...
    underground: [],
    black: [89, 90, 91, 106, 118, 87, 89, 72, 107, 118],
  },
  106: {
    taxi: [105, 107],
    bus: [],
  ...
  111: {
    ...
    black: [124, 110, 112, 124, 100, 79, 67, 163, 153],
  },
  112: {
    taxi: [111, 125, 100],
    bus: [],
  ...
  116: {
    ...
    bus: [86, 118, 127, 142],
    underground: [],
    black: [104, 117, 128, 127, 86, 118, 127, 128, 142],
  },
  117: {
    taxi: [88, 116, 118, 129],
    bus: [],
  ...
  118: {
    ...
    bus: [105, 116, 135],
    underground: [],
    black: [105, 117, 119, 105, 116, 135, 115],
  },
  119: {
    taxi: [118, 107, 136],
    bus: [],
  ...
  123: {
    ...
    bus: [122, 124, 144, 165],
    underground: [],
    black: [122, 124, 137, 148, 149, 122, 124, 144, 165],
  },
  124: {
    taxi: [109, 111, 123, 130, 138],
    bus: [77, 111, 123, 153],
    underground: [],
    black: [109, 111, 123, 130, 138, 77, 111, 123, 153],
  },
  125: {
    taxi: [112, 113, 131],
    bus: [],
  ...
  126: {
    taxi: [114, 115, 127, 132, 140],
    bus: [],
    underground: [],
    black: [114, 115, 127, 132, 140],
  },
  127: {
    taxi: [115, 116, 126, 133, 134],
    bus: [102, 116, 133],
    underground: [],
    black: [115, 116, 126, 133, 134, 102, 116, 133],
  },
  128: {
    taxi: [116, 129, 134, 142],
    bus: [],
    underground: [],
    black: [116, 129, 134, 142],
  },
  129: {
  ...
  135: {
    ...
    bus: [118, 159, 161],
    underground: [],
    black: [129, 136, 143, 161, 118, 159, 161],
  },
  136: {
    taxi: [119, 135, 162],
    bus: [],
  ...
  140: {
    ...
    black: [126, 132, 133, 139, 154, 156, 82, 133, 154, 156, 89, 153, 159],
  },
  141: {
  ...
  142: {
    ...
    bus: [116, 157, 159],
    underground: [],
    black: [128, 129, 134, 141, 143, 158, 159, 116, 157, 159],
  },
  143: {
  ...
  153: {
    ...
    black: [139, 152, 154, 166, 167, 124, 154, 180, 184, 111, 140, 163, 185],
  },
  154: {
    taxi: [139, 140, 153, 155],
    bus: [140, 153, 156],
    underground: [],
    black: [139, 140, 153, 155, 140, 153, 156],
  },
  155: {
  ...
  156: {
    ...
    bus: [140, 154, 157, 184],
    underground: [],
    black: [140, 155, 157, 169, 140, 154, 157, 184],
  },
  157: {
    taxi: [156, 158, 170],
    bus: [133, 142, 156, 185],
    underground: [],
    black: [156, 158, 170, 133, 142, 156, 185, 115, 194],
  },
  158: {
  ...
  159: {
    ...
    black: [142, 143, 160, 172, 188, 142, 135, 161, 187, 199, 89, 140, 185],
  },
  160: {
  ...
  161: {
    ...
    bus: [107, 135, 159, 199],
    underground: [],
    black: [135, 160, 174, 107, 135, 159, 199],
  },
  162: {
    taxi: [136, 175],
    bus: [],
  ...
  163: {
    ...
    bus: [144, 176, 191],
    underground: [111, 153],
    black: [146, 177, 144, 176, 191, 111, 153],
  },
  164: {
  ...
  165: {
    ...
    bus: [123, 180, 191],
    underground: [],
    black: [149, 151, 179, 180, 123, 180, 191],
  },
  166: {
  ...
  180: {
    ...
    bus: [153, 165, 184, 190],
    underground: [],
    black: [165, 181, 193, 153, 165, 184, 190],
  },
  181: {
  ...
  184: {
    ...
    bus: [153, 156, 180, 185],
    underground: [],
    black: [168, 169, 196, 197, 185, 153, 156, 180, 185],
  },
  185: {
    taxi: [170, 184, 186],
    bus: [157, 184, 187, 199],
    underground: [153, 159],
    black: [170, 184, 186, 157, 184, 187, 153, 159, 199],
  },
  186: {
    taxi: [171, 185, 198],
    bus: [],
  ...
  191: {
    ...
    bus: [163, 165, 190],
    underground: [],
    black: [178, 179, 190, 192, 163, 165, 190],
  },
  192: {
    taxi: [191, 190, 194],
    bus: [],
